...
int main(int argc, char** argv) {
  ...
  FILE *f1 = fopen("/home/vision/Desktop/code_c_c++/my_BA/problem-16-22106-pre.txt", "r");
  FILE *f2 = fopen("/home/vision/Desktop/code_c_c++/my_BA/preprocess_problem-16-22106-pre.txt", "w");
  ...
  for (int i = 0; i < n_point;i++){
      ...
      std::cout << *(bal_problem.parameters_ + i) << std::endl;
  }*/
